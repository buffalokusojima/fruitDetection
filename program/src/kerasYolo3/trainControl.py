...
def start_train(train_file, classes_path, output_path):
    
    if not util.check_file_exist(train_file, classes_path):
    ...
    class_names = util.get_class_list(classes_path)
    
    print("use classes below\n", class_names)
    ...
    output_class_file = os.path.join(log_dir, os.path.basename(classes_path))
    shutil.copy(classes_path, output_class_file)
    
    output_train_file = os.path.join(log_dir, os.path.basename(train_file))
    shutil.copy(train_file, output_train_file)
